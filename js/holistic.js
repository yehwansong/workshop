...
function onResultsHolistic(results) {
  ...
  if(results.faceLandmarks && results.leftHandLandmarks){
    if(get_dis(results.faceLandmarks[163].x, results.leftHandLandmarks[8].x, results.faceLandmarks[163].y,  results.leftHandLandmarks[8].y)<standard)
  }
  if(results.faceLandmarks && results.rightHandLandmarks){
    if(get_dis(results.faceLandmarks[390].x,results.rightHandLandmarks[8].x, results.faceLandmarks[390].y, results.rightHandLandmarks[8].y)<standard)
  }
  if(results.faceLandmarks && results.rightHandLandmarks){
